        ...
        <div className="navbar-end">
          ...
          {user ? (
            ...
            <>
              <Link
                to="/login"
                className="btn hover:bg-pink-800 hover:text-white  border-pink-800 bg-transparent text-black btn-xs md:btn-sm mr-2"
              >
                Login
              </Link>
              <Link
                to="/register"
                className="btn hover:bg-pink-800 hover:text-white  border-black text-black bg-transparent btn-xs md:btn-sm"
              >
                Register
              </Link>
            </>
